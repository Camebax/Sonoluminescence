...
T = 8000
show_plot(abs_energy_from_T, 'Температура источника [К]', 'Поглощаемая мощность [Вт]',
          'Мощность источника: ' + str(power) + '[Вт], ' + 'Толщина слоя Хлорина:' + str(round(l, 9)) + '[м]')
show_plot(abs_energy_from_l, 'Толщина слоя Хлорина, [м]', 'Поглощаемая мощность [Вт]',
          'Мощность источника:' + str(power) + '[Вт],' + 'Температура источника:' + str(T) + '[К]')
