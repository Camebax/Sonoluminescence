filepath = 'text_files/abs_spec_ce6.txt'

'''В ТОНИНЫХ ФАЙЛАХ СПЕКТРЫ ПОГЛОЩЕНИЯ ДАНЫ С ШАГОМ 2НМ !!!'''

def get_spectre(filepath):
    '''Извлекает спектр из текстового файла по адресу filepath и заносит его в словарь spectre, ключи - длины частот в НАНОМЕТРАХ!!!'''
    spectre = {}
